...
import (
	...
	machineactuator "github.com/gonzolino/cluster-api-provider-vagrant/cloud/vagrant/actuators/machine"
	"github.com/gonzolino/cluster-api-provider-vagrant/cloud/vagrant/controllers/machine/options"
)

const (
	controllerName = "vagrant-machine-controller"
)
...
func Start(server *options.Server, shutdown <-chan struct{}) {
	...
	if err != nil {
		glog.Fatalf("Could not create vagrant machine actuator: %v", err)
	}
