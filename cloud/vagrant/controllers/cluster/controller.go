...
import (
	...
	clusteractuator "github.com/gonzolino/cluster-api-provider-vagrant/cloud/vagrant/actuators/cluster"
	"github.com/gonzolino/cluster-api-provider-vagrant/cloud/vagrant/controllers/cluster/options"
)

const (
	controllerName = "vagrant-cluster-controller"
)
...
func Start(server *options.Server, shutdown <-chan struct{}) {
	...
	if err != nil {
		glog.Fatalf("Could not create vagrant cluster actuator: %v", err)
	}
